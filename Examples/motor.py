#!/usr/bin/env python3
from ev3dev2 import LargeMotor   #we're importing the motor function
from ev3dev2 import SpeedDPS, SpeedRPM, SpeedRPS, SpeedDPM #we're importing other functions related to speed
